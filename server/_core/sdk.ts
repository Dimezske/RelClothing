...
class SDKServer {
  ...
  async verifySession(
    ...
    try {
      ...
      // NOTE: `appId` (VITE_APP_ID) is a Manus multi-tenancy artifact that is
      // unset when running this app standalone. It intentionally isn't
      // required here — only `openId` identifies the session.
